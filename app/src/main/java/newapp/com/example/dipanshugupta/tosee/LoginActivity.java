...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    public void onClickButtonListener(){
        ...
        attempt = (TextView)findViewById(R.id.textView12);
        mEmailView = (AutoCompleteTextView) findViewById(R.id.email);
        mPasswordView = (EditText) findViewById(R.id.password);
        ...
        button_login.setOnClickListener(
                new OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if(mEmailView.getText().toString().equals("Dipanshu") &&
                                mPasswordView.getText().toString().equals("7795475466")){
                            Toast.makeText(LoginActivity.this,"user and password is correct",
                                    Toast.LENGTH_SHORT).show();
                            Intent Intent = new Intent("newapp.com.example.dipanshugupta.tosee.user");
